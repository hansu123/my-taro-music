...
import MyBanner from "../../components/common/banner/index";
import MyRecommend from "../../components/common/recommend/index";
import styles from './home.module.scss';
import { AtIcon, AtSearchBar } from 'taro-ui';
import { bindActionCreators } from "redux";
import MyLoading from "../../components/common/MyLoading/index";
import MySearch from "../../components/content/MySearch/index";
...
class Index extends Taro.Component {
  ...
  render() {
    if (!this.props.recommendList.length && !this.props.recommendList.length) return <MyLoading hide={true}></MyLoading>;
    return <View className={styles.home_wrapper}>
        <AtSearchBar placeholder="易烊千玺" value={this.state.keyword} actionName="取消" onFocus={this.changeSearchStatus} onActionClick={this.changeSearchStatus} onChange={this.changeKeyword} />
        ...
        <View className={styles.home_cate_wrapper}>
          ...
          <View className={styles.home_cate_item} onClick={() => {
            this.showDetail("4");
          }}>
            <View className={styles.home_cate_item_img}>
