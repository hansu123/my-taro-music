                  ...
                  <View>
                    <ScrollView
                      ...
                      {this.props.playList.tracks.map((song, index) => {
                        return (
                          <View key={song.id} className={styles.song_item} onClick={() => { this.changeMusic(index) }}>
